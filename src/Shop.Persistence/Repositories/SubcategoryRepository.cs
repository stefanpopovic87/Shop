...
{
    internal sealed class SubcategoryRepository : BaseRepository<Subcategory, ProductDbContext>, ISubcategoryRepository
    {
        public SubcategoryRepository(ProductDbContext context)
            : base(context)
        {
        }
