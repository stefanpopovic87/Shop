...
{
    public sealed class UpdateProductSizeQuantityCommandValidator : AbstractValidator<UpdateProductSizeQuantityCommand>
    {
        private readonly IProductSizeQuantityRepository _productSizeQuantityRepository;
        private readonly IProductRepository _productRepository;
        private readonly ISizeRepository _sizeRepository;

        public UpdateProductSizeQuantityCommandValidator(
