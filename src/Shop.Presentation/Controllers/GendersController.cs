...
using Shop.Application.Genders.Create;
using Shop.Application.Genders.Get;
using Shop.Application.Genders.List;
using Shop.Presentation.Controllers.Base;
using Swashbuckle.AspNetCore.Annotations;
using Mapster;
using Shop.Application.Genders.Update;
using Shop.Application.Genders.Delete;
